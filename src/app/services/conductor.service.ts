...
export class ConductorService {
  ...
  addConductor(conductor: ConductorInterface): void{
    ...
    this.conductoresCollection.add(conductorObj);
    */
  ...
  public uploadImage(conductor: ConductorInterface, image: ImagenInterface ){
